<div class="bg-white rounded-lg shadow overflow-hidden">
    ...
    <div class="p-6">
        <div class="flex flex-col items-center text-center mb-4">
            ...
            <h3 class="font-bold text-lg">{{ $mechanic->user->firstname }}</h3>
        ...
        <div class="mt-6 space-y-2">
            ...
            <a href="{{ $mechanic->user->phone }}" class="block w-full px-4 py-2 bg-blue-600 text-white text-center rounded-md hover:bg-blue-700">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
