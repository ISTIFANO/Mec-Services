...
<head>
    ...
    <title>Vehicule Dashboard</title>
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-3xl font-bold text-gray-800">Vehicule Dashboard</h2>
            <button id="openModal" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">+ Add Vehicule</button>
        </div>

        <!-- Table for vehicule data -->
            ...
            <table class="min-w-full bg-white border border-gray-300 shadow-lg rounded-lg">
                <thead>
                    <tr class="bg-gray-200 text-gray-700">
                        ...
                        <th class="py-3 px-4 text-left">Year of Manufacture</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        <td class="py-3 px-4">{{$vehicule->name}}</td>
                        <td class="py-3 px-4">{{$vehicule->model}}</td>
                        <td class="py-3 px-4">{{$vehicule->annee_fabrication}}</td>
                        <td class="py-3 px-4">{{$vehicule->year}}</td>
                        <td class="py-3 px-4 text-center">
                            <button class="bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600 transition-colors mr-2" onclick="openEditModal({{$vehicule->id}}, '{{$vehicule->name}}', '{{$vehicule->model}}', '{{$vehicule->annee_fabrication}}', '{{$vehicule->year}}')">
                                Edit
                            </button>
                            <button class="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600 transition-colors" onclick="confirmDelete({{$vehicule->id}})">
                                Delete
                            </button>
                        </td>
                    </tr>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg w-1/3">
                ...
                <form action="/admin/vehicule" method="POST" class="w-full">
                    ...
                    <div class="form-element mb-4">
                        ...
                        <input type="text" name="model" required placeholder="Model" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div class="form-element mb-4">
        ...
        <div id="editModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
            <div class="bg-white p-6 rounded-lg shadow-lg w-1/3">
                ...
                <form id="editForm" action="/admin/vehicule" method="POST" class="w-full">
                    ...
                    <div class="form-element mb-4">
                        <label for="model" class="block text-gray-700 mb-2">Model</label>
                        <input type="text" name="model" id="editModel" required placeholder="Model" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div class="form-element mb-4">
                        <label for="annee_fabrication" class="block text-gray-700 mb-2">Year of Manufacture</label>
        ...
        <div id="deleteModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
            <div class="bg-white p-6 rounded-lg shadow-lg w-1/3">
                ...
                <p class="mb-4">Are you sure you want to delete this vehicule?</p>
