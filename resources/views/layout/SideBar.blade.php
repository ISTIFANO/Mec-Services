            ...
            <nav class="flex-1 px-2 py-4 space-y-1">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu hidden px-2 py-1 mt-1 space-y-1 text-sm" data-menu="categories">
                  <a href="#category-list" class="flex items-center pl-9 pr-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md">
                    <i class="fas fa-list mr-3"></i>
                    All Categories
                  </a>
                  <a href="#category-add" class="flex items-center pl-9 pr-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md">
                    <i class="fas fa-plus mr-3"></i>
                    Add Category
                  </a>
                </div>
